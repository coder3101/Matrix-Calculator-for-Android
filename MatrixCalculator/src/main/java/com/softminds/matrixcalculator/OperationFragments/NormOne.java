 ...
 */
public class NormOne extends ListFragment {
    ...
    public void onListItemClick(ListView L, View V, int position, long id) {
        ...
        builder.setPositiveButton(R.string.copy, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                ClipData clipData = ClipData.newPlainText("NORM_ONE_RES", GetText(((GlobalValues) getActivity().getApplication()).GetCompleteList().get(pos).getNorm1()));
        ...
        builder.setMessage("First Norm is : " + GetText(((GlobalValues) getActivity().getApplication()).GetCompleteList().get(position).getNorm1()));
